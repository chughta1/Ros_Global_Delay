...
class CommonMavlinkStateMissonItemExecuted {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommonMavlinkStateMissonItemExecuted(null);
  ...
  static datatype() {
    ...
    return 'bebop_msgs/CommonMavlinkStateMissonItemExecuted';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommonMavlinkStateMissonItemExecuted(null);
...
module.exports = CommonMavlinkStateMissonItemExecuted;
